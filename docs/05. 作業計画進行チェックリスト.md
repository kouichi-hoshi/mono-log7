...
| ☐ | P1-LAY-03 | Header（ログイン状態）枠 | md以上: 表示切替（中央配置）＋ユーザーアイコン（右寄せ）の枠を表示。md未満: ユーザーアイコン（右寄せ）のみ表示。テストでGREEN | P1-LAY-01 | - | - |
...
| ☐ | P1-AUTH-04 | ユーザーアイコン + Popover（枠のみ） | アイコン押下でポップオーバー開閉。ユーザー名表示。**外側クリックで閉じる**。テストでGREEN | P1-LAY-03,P1-UI-07 | - | - |
