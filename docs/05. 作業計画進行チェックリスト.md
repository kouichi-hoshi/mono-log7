...
| 状態 | ID | 概要 | 完了条件 | 前提ID | 担当 | 期日 |
| --- | --- | --- | --- | --- | --- | --- |
| ☐ | P1-EDIT-01 | エディタ枠（tiptap設置） | **tiptapパッケージ導入済み**。tiptapエディタが表示され、テキスト入力可能。テストでGREEN | P1-ENV-04 | - | - |
...
| ☐ | P1-EDIT-04 | 保存ボタン → スタブCRUD連携 | postRepository.create呼出。sonnerで成功通知表示。テストでGREEN | P1-EDIT-03,P1-ADP-03,P1-UI-05 | - | - |
